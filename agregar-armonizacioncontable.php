    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <form action="manejador-armonizacioncontable.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-2 my-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="etiquetaTitulo" name="Anio" placeholder="Año">
                        </div>
                    </div>
                    <div class="col-md-4 my-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-4 my-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="etiquetaCategoria" name="Categoria">
                                <option value="Ejercicio Presupuestario">Ejercicio Presupuestario</option>
                                <option value="Inventarios">Inventarios</option>
                                <option value="Informacion Programatica">Informacion Programatica</option>
                                <option value="Informacion Presupuestal">Informacion Presupuestal</option>
                                <option value="Informacion Contable">Informacion Contable</option>
                                <option value="Informacion Disciplina Financiera">Informacion Disciplina Financiera</option>
                                <option value="Iniciativa y Proyecto">Iniciativa y Proyecto</option>
                                <option value="LI y PE">LI y PE</option>
                                <option value="Presupuesto Basado en Resultados">Presupuesto Basado en Resultados</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4 my-3">
