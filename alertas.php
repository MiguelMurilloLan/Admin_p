...
$listado = $datos->obtenerListadoAlertas();
...
<body>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <table class="table table-hover table-sm caption-top display" id="Contenidos">
                    ...
                    <tbody id="contenidoTabla">
                        ...
                        ?>
                            <tr>
                                <th scope="row"><?php echo $item['IdAlerta']; ?></th>
                                <td><?php echo $item['Nombre']; ?></td>
                                <td><?php echo $item['Fecha']; ?></td>
                                <td><?php echo $item['Lugar']; ?></td>
                                <td><?php echo $item['Estado']; ?></td>
                                <td><a style="margin-right: 10px;" href="editar-alerta.php?id=<?php echo $item['IdAlerta']; ?>"><i class="fas fa-edit"></i></a><a href="#" onclick="return false;"><i class="fas fa-trash-alt" id="<?php echo $item['IdAlerta']; ?>" onclick="borrarAlerta(this)"></i></a></td>
                            </tr>
                        <?php
                        }
                        ?>
    ...
    <script>
        ...
        function borrarAlerta(item) {
            var id = item.id
            $.ajax({
                url: "ajax/eliminar-alerta.php",
                type: "post",
                dataType: 'json',
                data: {
                    id: id
