...
<body>
    ...
    list($contenido, $img) = $datos->obtenerContenidoparaEditar($id);
                ...
                <form action="editar.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="etiquetaDescripcionCorta" name="DescripcionCorta" rows="3"><?php echo $contenido['DescripcionCorta']; ?></textarea>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label for="etiquetaDescripcion">Descripcion</label>
                            <textarea class="form-control" id="etiquetaDescripcion" name="Descripcion" rows="9"><?php echo $contenido['Descripcion']; ?></textarea>
                        </div>
                    </div>
                    <div class="form-row" style="display:flex; margin-top:1em;">
                        <div class="col-md-4 mb-3">
                            <label for="etiquetaLugar">Lugar</label>
                            <input type="text" class="form-control" id="etiquetaLugar" name="Lugar" placeholder="Lugar" value="<?php echo $contenido['Lugar']; ?>">
                        </div>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="RadioTipo" id="radioEventos" value="8" <?php echo ($contenido['IdGrupo'] == 8) ? 'checked' : ''; ?>>
                        <label class="form-check-label" for="exampleRadios1">
                            Evento
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="RadioTipo" id="radioEfemerides" value="9" <?php echo ($contenido['IdGrupo'] == 9) ? 'checked' : ''; ?>>
                        <label class="form-check-label" for="exampleRadios2">
                            Efemeride
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="RadioTipo" id="radioOtros" value="10" <?php echo ($contenido['IdGrupo'] == 10) ? 'checked' : ''; ?>>
                        <label class="form-check-label" for="exampleRadios3">
                            Otro
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="RadioTipo" id="radioOtros" value="32" <?php echo ($contenido['IdGrupo'] == 32) ? 'checked' : ''; ?>>
                        <label class="form-check-label" for="exampleRadios3">
                            Protocolo ALBA
                        </label>
                    </div>
                    ...
                    <div class="form-check mb-5">
                        <input class="form-check-input" name="Banner" type="checkbox" id="gridCheck1" <?php echo ($contenido['Banner']) ? 'checked' : ''; ?>>
