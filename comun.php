    <header class="header dark-bg" style="top: 0px;">
        <div class="toggle-nav">
            <div class="icon-reorder tooltips" data-original-title="Toggle Navigation" data-placement="bottom"><i class="icon_menu"></i></div>
        </div>

        <!--logo start-->
        <a href="index.php" class="logo">PDHEG <span class="lite">Admin</span></a>
        <!--logo end-->
            ...
            <li class="dropdown">
                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="profile-ava">
                                    <img  width="20px" src="../Recursos/icono_pag.png">
                                </span>
                ...
                <li>
                    <a href="../index.php"><i class="fas fa-dove"></i>Ir a Página Oficial</a>
                </li>
                <li>
                    <a href="login.php"><i class="icon_key_alt"></i> Cerrar Sesión</a>
                </li>
                </ul>
            </li>
    ...
    <!--sidebar start-->
    <aside >
      <div id="sidebar" class="nav-collapse " style="top: 0px;">
        <!-- sidebar menu start-->
