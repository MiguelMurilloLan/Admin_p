    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <h2 class="mt-3">Nuevo Contenido Otro</h2>
                <form action="agregar.php" method="POST" enctype="multipart/form-data">
                    <div class="form-row">
                        <h4 class="mt-4">Contenido</h4>
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="Tipo" value=10>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6">
                    ...
                    <button type="submit" name="submit" class="btn btn-primary mb-5 mt-3">Aceptar</button>
                </form>
            </main>
        </div>
    </div>
