    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <h2 class="mt-3">Nuevo Recomendacion</h2>
                <form action="manejador-recomendaciones.php" method="POST" enctype="multipart/form-data">
                    <div class="form-row">
                        <h4 class="mt-4">Recomendacion</h4>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="etiquetaExpediente">Expediente</label>
                                <input type="text" class="form-control" id="etiquetaExpediente" name="Expediente" placeholder="Expediente">
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-4" style=" margin-top:1em;">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="etiquetaDescripcionURL" name="DescripcionURL" placeholder="Descripcion URL">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlFile1">Agregar Archivo</label>
                        <input type="file" name="files" accept=".pdf" class="form-control-file">
                    </div>
                    <h4 class="mt-4">Activo</h4>
                    <div class="form-check mb-5">
                        <input class="form-check-input" name="Activo" type="checkbox" id="gridCheck1">
