    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <form action="manejador-editarrevistadh.php" method="POST" enctype="multipart/form-data">
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="oldURL" value="<?php echo $contenido['URL'] ?>">
                        </div>
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="oldImageURL" value="<?php echo $img[0]['URL'].$img[0]['Titulo'] ?>">
                        </div>
                        <div class="form-group">
                    ...
                    <a href="<?php if(substr($contenido['URL'], 0, 1) === '/'){echo "..";} echo $contenido['URL']?>"><?php echo basename($contenido['URL']); ?></p></a>
                    <div class="form-group">
                        <label for="exampleFormControlFile1">Reemplazar Archivo</label>
                        <input type="file" name="archivo" accept=".pdf" class="form-control-file">
                    </div>
