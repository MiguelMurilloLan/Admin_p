    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <h2 class="mt-3">Nuevo Webinar</h2>
                <form action="agregar.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="Tipo" value=36>
                    </div>
                    <div class="form-group">
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            <label for="etiquetaTitulo">Recurso</label>
                            <input type="text" class="form-control" id="etiquetaTitulo" name="Recurso" placeholder="Recurso">
                        </div>
                    </div>
