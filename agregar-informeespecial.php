    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <h2 class="mt-3">Nuevo Informe Especial</h2>
                <form action="manejador-informeespecial.php" method="POST" enctype="multipart/form-data">
                    <div class="form-row">
                        <h4 class="mt-4">Contenido</h4>
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="Tipo" value=43>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="files[]" accept=".jpg,.png,.jpeg" class="form-control-file">
                    </div>
