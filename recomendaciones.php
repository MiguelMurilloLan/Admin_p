...
$listado = $datos->obtenerListadoRecomendaciones();
...
<body>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <table class="table table-hover table-sm caption-top display" id="Contenidos">
                    ...
                    <tbody id="contenidoTabla">
                        ...
                        ?>
                            <tr>
                                <th scope="row"><?php echo $item['idRecomendacion']; ?></th>
                                <td><?php echo $item['FechaResolucion']; ?></td>
                                <td><?php echo $item['Expediente']; ?></td>
                                <td><a style="margin-right: 10px;" href="editar-recomendacion.php?id=<?php echo $item['idRecomendacion']; ?>"><i class="fas fa-edit"></i></a><a href="#" onclick="return false;"><i class="fas fa-trash-alt" id="<?php echo $item['idRecomendacion']; ?>" onclick="borrarRecomendacion(this)"></i></a></td>
                            </tr>
                        <?php
                        }
                        ?>
    ...
    <script>
        ...
        function borrarRecomendacion(item) {
            var id = item.id
            $.ajax({
                url: "ajax/eliminar-recomendacion.php",
                type: "post",
                dataType: 'json',
                data: {
                    id: id
